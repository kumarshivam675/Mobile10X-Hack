...
def waypoints(origin,destination):
    ...
    for i in range(0,limit):
        if data["routes"][0]["legs"][0]["steps"][i]["travel_mode"]=="TRANSIT":
            result+="\n"+"Take Bus from "+data["routes"][0]["legs"][0]["steps"][i]["transit_details"]["departure_stop"]["name"]
...
# destLatLong=getDestinationLatLong("forum")
# print destLatLong

# waypoints("12.959905, 77.647617","12.8446784,77.6610528")
print waypoints(getDestinationLatLong("domlur "),getDestinationLatLong("electronic city phase 1"))
